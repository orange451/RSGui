...
{
  private ArrayList<RSGuiNode> choices = new ArrayList();
  private ArrayList<RSGuiDropDownListener> dropListener = new ArrayList();
  ...
  public RSGuiTextButton addChoice(final String choice)
  {
    ...
    this.panel.add(b);
    b.setLocation(b.x, b.y + this.choices.size() * b.getHeight());
