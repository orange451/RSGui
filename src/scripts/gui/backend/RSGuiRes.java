...
public class RSGuiRes
{
  ...
  public static final RSFont FONT_BOLD = new RSFont(AwtUtil.getFont(getURL("http://firstrecon.net/public/tribot/textBold.ttf")));
  public static final RSFont FONT_REGULAR = new RSFont(AwtUtil.getFont(getURL("http://firstrecon.net/public/tribot/textRegular.ttf")));
