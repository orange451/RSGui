...
public class RSGuiScrollPanel extends RSGuiPanel {
	...
	public RSGuiScrollPanel(int x, int y, int width, int height) {
	...
	protected void paint(Graphics g) {
		...
		g2.setColor( RSGuiFrame.BACKGROUND_COLOR );
		g2.fillRect(0, 0, panelImage.getWidth(), panelImage.getHeight());
		g2.setColor( Color.white );

		// Paint all elements to me
		this.scrollUp.y   = scrollY + 1;
		this.scrollDown.y = height + scrollY - 1 - scrollDown.getHeight();
		for (int i = nodes.size() - 1; i >= 0; i-- ) {
